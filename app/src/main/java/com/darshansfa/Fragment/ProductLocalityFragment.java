...
public class ProductLocalityFragment extends Fragment {
    ...
    public ProductLocalityFragment() {
    }

    public static ProductLocalityFragment newInstance() {
        ProductLocalityFragment fragment = new ProductLocalityFragment();
        return fragment;
    }
    ...
    private void listProduct() {
        List<Product> notes = Product.find(Product.class, "locality_id = ? ", new String[]{PreferencesManger.getStringFields(getActivity(), Constants.Pref.LOCALITY_ID)});
        Log.e("Prod", "------------" + notes);
