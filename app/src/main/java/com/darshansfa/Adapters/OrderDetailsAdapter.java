...
public class OrderDetailsAdapter extends RecyclerView.Adapter<OrderDetailsAdapter.ViewHolder> {
    ...
    public OrderDetailsAdapter(ArrayList<OrderPart> arrayList, String from) {
    ...
    public void onBindViewHolder(OrderDetailsAdapter.ViewHolder holder, int position) {
        ...
        if ((from.matches(Constants.ORDER_OPEN))||(from.matches(Constants.ORDER_PENDING))) {
            holder.tvOrderQty.setText("Qty : " + cart.getQuantity());
        } else {
            holder.tvOrderQty.setText("Shipped Qty : " + cart.getShipped_quantity());
        }
